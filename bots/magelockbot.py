...
class MagelockBotFrame(wx.Dialog):
    ...
    def add_buff_btns(self):
        ...
        b_eat.Bind(wx.EVT_BUTTON, self.__btn_ctrl(delayfn(self.warlock_ctrl.eat, 0, 1000), delayfn(self.mage_ctrl.eat, 0, 1000)))
        b_drink.Bind(wx.EVT_BUTTON, self.__btn_ctrl(delayfn(self.warlock_ctrl.drink, 0, 1000), delayfn(self.mage_ctrl.drink, 0, 1000)))
